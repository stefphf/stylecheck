...
```json
{
  ...
  "structure": {
    "required_sections": [
      ...
      { "pattern": "список.*источник",   "label": "Список источников","severity": "error" }
    ]
  },
  "terminology": {
    "forbidden_terms": [
      { "term": "баг", "suggestion": "Используйте «ошибка»", "severity": "warning" }
    ]
  },
  "gost_page": {
    "margin_left_mm": 30.0,
...
Разработан в рамках выпускной квалификационной работы в Университете ИТМО, 2025.  
